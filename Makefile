...
######################################################################################
GCC_BASE = /home/sunbeam/ARM/Toolchain/gcc-arm-none-eabi-5_4-2016q2/
...
PROJECT_OBJECTS   = USB_device.o startup_LPC17xx.o system_LPC17xx.o
PROJECT_OBJECTS   += lcd.o rtc.o usbhw_lpc.o  usbcontrol.o usbinit.o usbstdreq.o
PROJECT_INC_PATHS = -I.
PROJECT_LIB_PATHS = -L.
PROJECT_LIBRARIES =
...
# run as "sudo make program"
program:
	echo "flashing program : $(PROJECT).bin"
	mount /dev/sdb /mnt
	dd if=$(PROJECT).bin of=/mnt/firmware.bin conv=nocreat,notrunc
	umount /mnt
